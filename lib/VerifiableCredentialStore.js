...
export class VerifiableCredentialStore {
  ...
  async upsert({
    ...
    /* Note: Here we need to decide whether to guess that the credential is
    new or not to determine whether to create a new EDV document or fetch
    and update an existing one. A wrong guess will still work either way, but
    we'll it will slow performance because we will have to try again after
    adjusting our guess.
